...
| プラン | 月額料金 | 会話量 | 画像生成 | 主な機能 | 想定粗利率 |
|--------|---------|--------|----------|----------|------------|
| **フリー** | ¥0 | 10回/日 | 1枚/月 | 基本機能のみ | - |
| **ライト** | ¥980 | 50回/日 | 5枚/月 | 性格カスタマイズ | 約30% |
| **スタンダード** | ¥2,980 | 200回/日 | 20枚/月 | Character Reference、高度な設定 | 約70% |
| **プレミアム** | ¥4,980 | 無制限 | 50枚/月 | 複数パートナー(2体)、優先応答 | 約80% |
| **アルティメット** | ¥9,800 | 無制限 | 無制限 | 全機能、専用学習モデル | 約85% |
